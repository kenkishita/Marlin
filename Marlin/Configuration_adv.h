...
#define DIGIPOT_I2C_MOTOR_CURRENTS {1.0, 1.0, 1.0, 1.0}
...
//#define FWRETRACT  //ONLY PARTIALLY TESTED
  ...
  #define RETRACT_RECOVER_LENGTH_SWAP -0.1  //default additional swap recover length (mm, added to retract length when recovering from extruder change)
  #define RETRACT_RECOVER_FEEDRATE 12     //default feedrate for recovering from retraction (mm/s)
#endif
